...
class BrandConfig:
    ...
    def __init__(self):
        ...
        # Generic service references for user-facing messages - hardcoded for deployment stability
        self.domain_registrar_name = 'OpenProvider'
        self.payment_processor_name = 'DynoPay'
        self.dns_service_name = 'Cloudflare'
...
def get_payment_success_message(amount: str, crypto_currency: str, lang_code: str = 'en', payment_method: str = 'crypto') -> str:
    ...
    if LOCALIZATION_AVAILABLE:
        ...
        if payment_method == 'wallet':
            details = t_fmt('success.wallet_payment_details', lang_code,
        ...
        # Fallback to original hardcoded message
        if payment_method == 'wallet':
            return create_success_message("Payment Confirmed!", f"Thank you for your payment of ${escape_html(amount)} USD.\n\nYour order is confirmed and processing has started.\n\n✅ Wallet balance updated")
        else:
