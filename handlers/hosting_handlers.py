...
async def show_hosting_plans(query):
    ...
    from handlers import show_hosting_plans as _show_hosting_plans
...
async def show_hosting_management(query, subscription_id: str):
    ...
    from handlers import show_hosting_management as _show_hosting_management
...
async def show_hosting_details(query, subscription_id: str):
    ...
    from handlers import show_hosting_details as _show_hosting_details
...
async def show_cpanel_login(query, subscription_id: str):
    ...
    from handlers import show_cpanel_login as _show_cpanel_login
...
async def show_hosting_usage(query, subscription_id: str):
    ...
    from handlers import show_hosting_usage as _show_hosting_usage
...
async def handle_renew_suspended_hosting(query, subscription_id: str):
    ...
    from handlers import handle_renew_suspended_hosting as _handler
...
async def handle_unified_hosting_only(query, context, plan_id: str):
    ...
    from handlers import handle_unified_hosting_only as _handler
...
async def process_unified_wallet_payment(query, subscription_id: str, price: str):
    ...
    from handlers import process_unified_wallet_payment as _handler
...
async def process_unified_crypto_payment(query, crypto_type: str, subscription_id: str, price: str):
    ...
    from handlers import process_unified_crypto_payment as _handler
...
async def create_unified_hosting_account_after_payment(subscription_id: int):
    ...
    from handlers import create_unified_hosting_account_after_payment as _handler
