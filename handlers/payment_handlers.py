...
async def wallet_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from handlers_main import wallet_command as _handler
    return await _handler(update, context)


async def show_wallet_interface(query, context=None):
    """Show wallet interface"""
    from handlers_main import show_wallet_interface as _handler
...
async def show_wallet_balance(query, context):
    """Show wallet balance"""
    from handlers_main import show_wallet_balance as _handler
    return await _handler(query, context)


async def show_wallet_transactions(query, context):
    """Show wallet transaction history"""
    from handlers_main import show_wallet_transactions as _handler
    return await _handler(query, context)
